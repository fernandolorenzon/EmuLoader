...
namespace EmuLoader.Gui.Forms
{
    public partial class FormMain
    {
        ...
        private void OpenPicture(string type)
        {
            ...
            Rom rom = (Rom)dataGridView.SelectedRows[0].Tag;
            var picPath = Environment.CurrentDirectory + "\\" + RomFunctions.GetRomPicture(rom, type);

            ProcessStartInfo psi = new ProcessStartInfo
            {
                FileName = picPath,
                UseShellExecute = true // This makes the system use the default application associated with the file type
            };
